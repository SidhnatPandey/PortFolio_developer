...
export function AchievementsSection() {
  const achievements = [
    ...
    },
    {
      ...
      description: "First place in a 36-hour hackathon for building a sustainable technology solution.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-8 h-8">
  ...
  return (
    <section id="achievements" className="py-20 bg-secondary/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex flex-col h-full">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-bold mb-1 group-hover:text-primary transition-colors">{achievement.title}</h3>
                        <p className="text-sm text-foreground/70">{achievement.organization}</p>
                      </div>
                    </div>
        ...
        >
          <div className="inline-block rounded-full bg-primary/10 px-6 py-3 hover:bg-primary/20 transition-colors cursor-pointer">
